...
maximum_distance: 'all',
mileage_max: '',
models: ['volvo-s60', 'volvo-s60_hybrid', 'volvo-s60_inscription', 'volvo-s60_recharge_plug_in_hybrid'],
page_size: 200,
sort: 'list_price',
stock_type: 'all',
trims: ['volvo-s60-t8_inscription', 'volvo-s60_recharge_plug_in_hybrid-t8_black_edition_r_design_extended_range',
'volvo-s60_recharge_plug_in_hybrid-t8_inscription_extended_range', 'volvo-s60_recharge_plug_in_hybrid-t8_plus_black_edition',
'volvo-s60_recharge_plug_in_hybrid-t8_plus_dark_theme', 'volvo-s60_recharge_plug_in_hybrid-t8_r_design_extended_range',
'volvo-s60_recharge_plug_in_hybrid-t8_ultimate_black_edition', 'volvo-s60_recharge_plug_in_hybrid-t8_ultimate_bright_theme'],
year_max: '',
year_min: 2022,
zip: 27599
}
...
function buildUrl(base, params) {
  const fullParams = Object.keys(params).reduce((acc, param) => {
    ...
    if (typeof value === 'object') {
      return value.reduce((acc, subParam) => `${acc}&${param}[]=${subParam}`, '')
    } else {
...
console.log(buildUrl(urlBase, params))